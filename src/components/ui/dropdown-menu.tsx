  ...
  return (
    <DropdownMenuPrimitive.Portal>
      <DropdownMenuPrimitive.Content
        ...
        className={cn(
          "z-50 min-w-[12rem] overflow-hidden rounded-none bg-white p-1 text-popover-foreground",
          className
        )}
        style={{
          // 基本樣式
          boxShadow: "0 20px 30px -10px rgba(0,0,0,0.5), 0 10px 20px -5px rgba(0,0,0,0.3)",
